    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idc', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='repository.idc', verbose_name='IDC机房')),
                ('tag', models.ManyToManyField(to='repository.Tag')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_at', models.DateTimeField(auto_now_add=True)),
                ('asset_obj', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='repository.server')),
            ],
            options={
